...
def arg_parse():
    ...
    parser.add_argument('--img_num', type=int, default=300,
...
if __name__ == "__main__":
    ...
    data_path = "./dataset/dataset-"       # resolution string will be concatenated in ScalableLoader
    ...
    d = nn.DataParallel(D(loss_type=arg.loss)).to(torch_device)
